                ...
                <section class="history card-full-fixed">
                    <div class="settings-form">
                        <form action="../assets/includes/submit-setup.php" method="post">
                            ...
                            <br>
                            <p>Check Log In</p>
                            <label class="container">Check if user is logged in (for debugging).
                            ...
                            <br>
                            <p>Disguise</p>
                            <label class="container">Modify language to disguise the website (leave unchecked for
                                accurate settings description).
                                <input type="checkbox" name="isDisguised" <?php
                                    $isDisguised = "";
                                    if ($setup["isDisguised"]) {
                                        $isDisguised = "checked";
                                    }
                ...
                <section class="history card-full-fixed">
                    <div class="settings-form">
                        <form action="../assets/includes/submit-user.php" method="post">
                            ...
                            <div class="input-text-container">
                                <br>
                                <input type="password" input="text" name="newPwd" id="password"
                                    class="container input-text newPwd">
                                <span class="bi bi-eye-slash bi-eye" id=" togglePassword" for="newPwd"
                                    onclick="pwdReveal(this)"></span>
                            </div>
                            ...
                            <div class="input-text-container">
                                <br>
                                <input type="password" input="text" name="confirmPwd" id="password"
                                    class="container input-text confirmPwd">
                                <span class="bi bi-eye-slash bi-eye" id="togglePassword" for="confirmPwd"
                                    onclick="pwdReveal(this)"></span>
                            </div>
                            ...
                            <div class="input-text-container">
                                <br>
                                <input type="password" input="text" name="currentPwd" id="password"
                                    class="container input-text currentPwd">
                                <span class="bi bi-eye-slash bi-eye" id="togglePassword" for="currentPwd"
                                    onclick="pwdReveal(this)"></span>
                            </div>
