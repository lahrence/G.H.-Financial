                ...
                <div class="settings-form log-in-form">
                    <form action="../assets/includes/login.php" method="post">
                        ...
                        <div class="input-text-container">
                            <br>
                            <input input="number" name="username" class="container input-text" value="<?php
                                    if (isset($_GET["usr"])){
                                        echo $_GET["usr"];
                                    }
                                ?>">
                        ...
                        <div class="input-text-container">
                            <br>
                            <input type="password" input="text" name="password" id="password"
                                class="container input-text password">
                            <span class="bi bi-eye-slash bi-eye" id="togglePassword" for="password"
