...
if (!$isRoot) {
    echo '<div class="content-div navbar">
        ...
        <ul class="navbar-content">
            ...
            <a href="'.$path.'transfer/"><span class="navbar-content-text"><span class="material-icons" style="vertical-align: middle; margin-right: 30px;">sync_alt</span>TRANSFER</span></a>
        ...
        <nav>
            <div class="nav-top">
                <div class="nav-top-container">
                    <ul>
                        <li class="current-page-btn"><a>Personal</a></li>
            ...
            <div class="nav-bottom">
                <div class="nav-bottom-container">
                    <ul>
                        <li><a href="'.$path.'"><img src="'.$path.'assets/images/logo/logo-title.png"/></a></li>
                        <li><a>Accounts</a></li>
                        <li><a>How To</a></li>
                        <li><a>Products</a></li>
                        <li><a>Solutions</a></li>
                    </ul>
                    <ul class="nav-bottom-right dashboard-btn">
